...
public class NewNodeContextPanel extends Composite implements OverlayDataLoadedHandler, OverlayDataResetHandler,
PairwiseNumbersLoadedHandler, PairwiseInteractorsResetHandler{
	...
	private Button getButton(String text, ImageResource imageResource) {
		...
		Button btn = new Button(safeHtml, e -> onClick(e));
		this.btns.add(btn);
	...
	public interface ResourceCSS extends CssResource {
		String CSS = "org/reactome/web/fi/client/popups/NewNodeContextPanel.css";
